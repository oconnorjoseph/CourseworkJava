...
public class TesterRunner {
	...
	private static void testTerminalUnhappyCase() {
		System.out.println("     Testing terminal unhappy case of sum terminal computation on String column...");
	...
	private static void testTerminalHappyCases() {
		System.out.println("     Testing happy cases of terminal computation...");
	...
	private static void testPipelineOutsideHeaderFilterDuplicateFilters() {
		...
		try {
			filter = new TSVFilter.Builder(BASE_URL, EXAMPLE_NAME)
					.selectAny("Car", 200).compute("Name", Terminal.MIN).compute("Name", Terminal.MAX).done();
		} catch (FileNotFoundException e1) {
			e1.printStackTrace();
		}
		TSVPipeline pipeline = new TSVPipeline(filter);
	...
	private static final String EXAMPLE_NAME = "example.tsv",
			EXAMPLE_ALLSAME_DESTINATION_NAME = "exampleD3Allsame.tsv",
			EXAMPLE_COUNT_DESTINATION_NAME = "exampleD3Count.tsv",
			EXAMPLE_MIN_DESTINATION_NAME = "exampleD3Min.tsv",
			EXAMPLE_MAX_DESTINATION_NAME = "exampleD3Max.tsv",
			EXAMPLE_SUM_DESTINATION_NAME = "exampleD3Sum.tsv",
			EXAMPLE_ONE_LONG_FILTER_COUNT_DESTINATION_NAME = "exampleD3OneLongFilterCount.tsv",
			EXAMPLE_IMPOSSIBLE_FILTER_ALLSAME_DESTINATION_NAME = "exampleD3ImpossibleFilterAllsum.tsv",
			EXAMPLE_OUTSIDE_HEADER_FILTER_MULTIPLE_DESTINATION_NAME = "exampleD3OutsideHeaderMultiple.tsv",
			EXAMPLE_OUTSIDE_HEADER_FILTER_DUPLICATE_DESTINATION_NAME = "exampleD3OutsideHeaderDuplicate.tsv";
}
